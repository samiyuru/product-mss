...
import org.wso2.carbon.mss.servlet.interceptor.NettyInterceptor;
...
//        } else {
//            throw new RuntimeException("NO_NETTY_SERVLET_HANDLER_FOUND " + request.getUri());
//        }
        handleHttpServletRequest(ctx, request, new NettyHttpContextHandler("/"));
    }
